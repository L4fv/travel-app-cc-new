export const myTemplate = (params: any) => {
  return `
  ...
  <body style="
      ...
      <table dir="ltr" class="body" style="
          border-spacing: 0;
                ...
                ">
                    ...
                    ">
                        ...
                        ">
                            ...
                            text-align: left;
                          ">
                                              <th class="columns first large-12 last small-12" style="
                              color: #0a0a0a;
                              font-family: 'Cereal', Helvetica, Arial, sans-serif;
                              font-weight: normal;
                              padding: 0;
                            ...
                            ">
                              ...
                              ">
                                                      <img align="center" alt="samiria" class="center standard-header"
                                                          height="80"
                                                          src="${params.origen}/${params.brand}/images/logo.png" style="
                                  outline: none;
                                  text-decoration: none;
                        ...
                        ">
                          ...
                          ">
                              ...
                              padding-right: 16px;
                            ">
                                                  <p class="headline headline-lg heavy max-width-485" style="
                                padding: 0;
                                margin: 0;
                                text-align: left;
                        ...
                        ">
                          ...
                          ">
                              ...
                              padding-right: 16px;
                            ">
                                                  <p class="body body-lg body-link-rausch light text-left" style="
                                padding: 0;
                                margin: 0;
                                font-family: 'Cereal', 'Helvetica', Helvetica,
                                  Arial, sans-serif;
                              ...
                              ">
                                                      Bienvenido a 
                                                      <a href="${params.origen}">${params.titleMail}</a>
                                                      <br />
                                                      <br />
                                                      Gracias por confiar en nosotros para tu siguiente
                        ...
                        ">
                          ...
                          ">
                            ...
                            ">
                                                  <div class="">
                                                      <hr class="standard-footer-hr" style="
                                  max-width: 580px;
                                  border-right: 0;
                                  border-top: 0;
                                ...
                                " />
                                                      ...
                                                      <p class="standard-footer-text" style="
                                  padding: 0;
                                  margin: 0;
                                  text-align: left;
                                  margin-bottom: 10px;
      ...
      <div class="gmailfix" style="
          ...
          color: white;
        "></div>
      <img alt="" width="1" height="1" border="0" style="
