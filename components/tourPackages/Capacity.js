...
var TourPackageCapacity = function (_a) {
  var defaultCapacity = _a.defaultCapacity,
    min = _a.min,
    max = _a.max,
    onChange = _a.onChange;
  var _b = (0, react_2.useState)(defaultCapacity),
    capacity = _b[0],
    setCapacity = _b[1];
  ...
  return (
    <div className="text-center my-4">
      ...
      <div className="flex justify-center items-center space-x-2">
        ...
        <button
          onClick={function () {
            return setCapacity(Math.min(capacity + 1, max));
          }}
          className="bg-gray-200 hover:bg-gray-300 disabled:bg-gray-200 disabled:opacity-50 p-2 rounded-full"
          title={"M\u00E1ximo ".concat(max)}
