    ...
    <Grid container xs={12}>
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          ...
          <Tab label="Itinerario" {...a11yProps(2)} sx={{ xs:"none" }}/>
          <Tab label="Actividades" {...a11yProps(3)} sx={{ xs:"none" }} />
          <Tab label="No Incluye" {...a11yProps(4)} sx={{ xs:"none" }}/>
          <Tab label="Notas" {...a11yProps(5)} sx={{ xs:"none" }}/>
        </Tabs>
      </Box>
      ...
      <TabPanel value={value} index={2} sx={{ xs:"none" }}>
        <Grid container spacing={1}>
          <Grid xs={12} md={12}>
            <div
              className="prose overflow-hidden"
