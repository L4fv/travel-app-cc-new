...
var MyDocument = /** @class */ (function (_super) {
    ...
    MyDocument.prototype.render = function () {
        return (<document_1.Html lang="es">
        <document_1.Head>
          <link rel="preconnect" href="https://fonts.gstatic.com"/>
          <link rel="stylesheet" href={config_1.config.font.url}/>
          <link rel="icon" href={config_1.config.assetImg(config_1.config.images.icon)}/>
        </document_1.Head>
